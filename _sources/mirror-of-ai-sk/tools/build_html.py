#!/usr/bin/env python3
"""
build_html.py — Convert extracted EPUB of "Zrkadlo umelej inteligencie" (Slovak edition)
into a single-page interactive HTML file.

Reads from:  /tmp/epub-extract-sk/OEBPS/
Writes to:   <repo>/_sources/mirror-of-ai-sk/output/mirror.html
...
# Paths
# ---------------------------------------------------------------------------
EPUB_ROOT = Path("/tmp/epub-extract-sk/OEBPS")
...
<title>Zrkadlo umelej inteligencie &mdash; R&oacute;bert Barc&iacute;k</title>
<style>
/* ===================================================================
...
<main class="main-content" id="mainContent">
  ...
  <div class="cover-section">
    <img src="{cover_data_uri}" alt="Zrkadlo umelej inteligencie — ob&aacute;lka">
    <h1>Zrkadlo umelej inteligencie</h1>
