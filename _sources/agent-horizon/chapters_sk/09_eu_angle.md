...
> **Poznámka zo septembra 2026.** Brány sa pohli, oboma smermi. Obmedzenie najschopnejších amerických modelov podľa štátnej príslušnosti bolo 30. júna zrušené s trvalými podmienkami (dodávateľ odhaľuje a hlási zneužitie a koordinuje štandardy pre budúce modely s vládou USA); všeobecne dostupná úroveň je od 1. júla k dispozícii celosvetovo, kým neobmedzená úroveň ostáva preverovaným, prevažne americkým organizáciám. 10. septembra dostala agentúra EÚ pre kybernetickú bezpečnosť ENISA prístup k tej neobmedzenej úrovni po troch mesiacoch rokovaní, o jednu verziu pozadu za aktuálnou. A OpenAI 3. septembra spustilo svoj vlastný špičkový model najprv za kyberneticky preverenou kohortou, podľa vlastných pravidiel pripravenosti, nie na vládny príkaz. Čítané spolu: prístup k špičke je dnes u oboch vedúcich laboratórií odstupňovaný podľa preverenia a jurisdikcie a úroveň, v ktorej európsky kupujúci skončí, sa vyjednáva, agentúra po agentúre. Vzor smerovania nižšie je architektúra, ktorá to absorbuje.
