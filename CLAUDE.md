...
(Agent Horizon). All prose is translated by Fable 5 itself, never by smaller models; each SK page
carries a translator's note and links back to the EN original; EN pages link forward.
